  ...
  methods: {
    ...
    crop() {
      ...
      ctx.drawImage(
        ...
        (this.$refs.image.naturalHeight / 2) - (this.getCropRect().height * ratio / this.scale / 2) - (this.translate.y * ratio)
        + ((Math.round(this.getContainerRect().height) - this.$refs.image.height) * ratio / 2),
